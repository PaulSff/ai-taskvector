"""
NetworkEnvironmentSpec: integration layer for network workflows.
...
class TaskvectorEnvironmentSpec:
    """TaskvectorEnvironmentSpec for taskvector workflows. Step-based; no physical state."""

    def register_units(self) -> None:
        try:
            register_taskvector_units()
