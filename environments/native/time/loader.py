"""
Time management env loader: build from process_graph + goal via env_factory.
Python-only (CalendarICS and future time management units).
"""
...
def load_time_env(
    ...
    **kwargs: Any,
    ...
    """Build time env from process graph + goal (delegate to env_factory)."""
