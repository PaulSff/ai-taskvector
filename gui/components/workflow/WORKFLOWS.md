...
Workflow definitions (`.json` DAGs) under `gui/components/workflow/` are grouped by purpose (RAG helper graphs additionally live under **`rag/workflows/`** at repo root):
