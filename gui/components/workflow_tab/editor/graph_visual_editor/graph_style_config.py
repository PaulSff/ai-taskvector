...
TODO_STICKER_HEIGHT = 170
TODO_STICKER_BORDER_RADIUS = 10
TODO_STICKER_MAX_VISIBLE_TASKS = 6

TODO_STICKER_TITLE_SIZE = 11
TODO_STICKER_TASK_SIZE = 9
TODO_STICKER_SECONDARY_SIZE = 8

TODO_STICKER_BORDER = 1
TODO_STICKER_PADDING = 6
TODO_STICKER_LINE_SPACING = 2

TODO_STICKER_BG = "#161B22"
TODO_STICKER_BORDER_COLOR = "#2A2A2A"
TODO_STICKER_TEXT_COLOR = "#E6E6E6"
TODO_STICKER_SECONDARY_COLOR = "#B6B6B6"
TODO_STICKER_DONE_COLOR = "#4CAF50"
TODO_STICKER_ACTIVE_COLOR = "#EAEAEA"
