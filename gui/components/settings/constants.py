...
# LLM settings (per-agent profiles)
#
# Back-compat note:
...
# Ollama generation options for agent workflows (passed to LLMAgent.params["options"])
...
# Chat history persistence (agents chat)
...
KEY_MYDATA_DIR = (
    "mydata_dir"  # where user content to index lives (workflows, nodes, docs)
)
...
# Analyst chat: run RAG-based auto-delegation before the main agent workflow when enabled.
KEY_AUTO_DELEGATION_IS_ALLOWED = "auto_delegation_is_allowed"
DEFAULT_AUTO_DELEGATION_IS_ALLOWED = False
# Legacy app_settings key; cap lives in ``agents/roles/workflow_designer/role.yaml`` ``follow_up_max_rounds``.
...
# agent / chat workflow and prompt paths (relative to repo root; from app_settings.json where persisted).
# RAG context workflow path: ``agents/tools/rag_search/tool.yaml`` ``workflow`` (see ``get_rag_context_workflow_path``).
...
KEY_RAG_UPDATE_WORKFLOW_PATH = (
    "rag_update_workflow_path"  # legacy app_settings key; migrated out to ragconf
)
KEY_CREATE_FILENAME_WORKFLOW_PATH = "create_filename_workflow_path"
DEFAULT_CREATE_FILENAME_WORKFLOW_PATH = (
    "agents/roles/chat_name_creator/create_filename.json"
)

# Prompt template paths for agent workflows (relative to repo root)
...
KEY_LEFT_PANEL_WIDTH = "left_panel_width"
KEY_RIGHT_PANEL_WIDTH = "right_panel_width"
DEFAULT_LEFT_PANEL_WIDTH = 12
DEFAULT_RIGHT_PANEL_WIDTH = 382
KEY_LEFT_PANEL_VISIBLE = "left_panel_visible"
KEY_RIGHT_PANEL_VISIBLE = "right_panel_visible"
DEFAULT_LEFT_PANEL_VISIBLE = False
DEFAULT_RIGHT_PANEL_VISIBLE = True
...
KEY_TELEGRAM_CONVERSATIONS_DIR = "telegram_conversations_dir"
KEY_TELEGRAM_BOT_POLLER_LOCK_FILE_PATH = "telegram_bot_poller_lock_file_path"
## Orchestrator
...
KEY_TURN_DRIVER_JOB_PUB_ENDPOINTS = "turn_driver_zmq_job_pub_endpoints"
DEFAULT_TURN_DRIVER_JOB_PUB_ENDPOINTS = "tcp://127.0.0.1:6601"
KEY_TURN_DRIVER_RESPONSE_ENDPOINTS = "turn_driver_zmq_response_endpoints"
DEFAULT_TURN_DRIVER_RESPONSE_ENDPOINTS = "tcp://127.0.0.1:6610"
KEY_TURN_DRIVER_UPDATE_BATCH_ENDPOINTS = "turn_driver_zmq_update_endpoints"
DEFAULT_TURN_DRIVER_UPDATE_BATCH_ENDPOINTS = "tcp://127.0.0.1:9901"
KEY_TURN_DRIVER_MAX_CONCURRENT_CALLS = "turn_driver_max_concurrent_calls"
DEFAULT_TURN_DRIVER_MAX_CONCURRENT_CALLS = 10

# Core workflows
KEY_CORE_WORKFLOWS_JOB_PUB_ENDPOINTS = "core_workflows_zmq_job_pub_endpoints"
DEFAULT_CORE_WORKFLOWS_JOB_PUB_ENDPOINTS = "tcp://127.0.0.1:6621"
KEY_CORE_WORKFLOWS_RESPONSE_ENDPOINTS = "core_workflows_zmq_response_endpoints"
DEFAULT_CORE_WORKFLOWS_RESPONSE_ENDPOINTS = "tcp://127.0.0.1:6630"
KEY_CORE_WORKFLOWS_CONCURRENT_CALLS = "core_workflows_max_concurrent_calls"
DEFAULT_CORE_WORKFLOWS_CONCURRENT_CALLS = 10

# Agents workflows
KEY_AGENTS_WORKFLOWS_JOB_PUB_ENDPOINTS = "agents_workflows_zmq_job_pub_endpoints"
DEFAULT_AGENTS_WORKFLOWS_JOB_PUB_ENDPOINTS = "tcp://127.0.0.1:6121"
KEY_AGENTS_WORKFLOWS_RESPONSE_ENDPOINTS = "agents_workflows_zmq_response_endpoints"
DEFAULT_AGENTS_WORKFLOWS_RESPONSE_ENDPOINTS = "tcp://127.0.0.1:6130"
KEY_AGENTS_WORKFLOWS_CONCURRENT_CALLS = "agents_workflows_max_concurrent_calls"
DEFAULT_AGENTS_WORKFLOWS_CONCURRENT_CALLS = 10

# Tools workflows
KEY_TOOLS_WORKFLOWS_JOB_PUB_ENDPOINTS = "tools_workflows_zmq_job_pub_endpoints"
DEFAULT_TOOLS_WORKFLOWS_JOB_PUB_ENDPOINTS = "tcp://127.0.0.1:4663"
KEY_TOOLS_WORKFLOWS_RESPONSE_ENDPOINTS = "tools_workflows_zmq_response_endpoints"
DEFAULT_TOOLS_WORKFLOWS_RESPONSE_ENDPOINTS = "tcp://127.0.0.1:4664"
KEY_TOOLS_WORKFLOWS_CONCURRENT_CALLS = "tools_workflows_max_concurrent_calls"
DEFAULT_TOOLS_WORKFLOWS_CONCURRENT_CALLS = 10

# GUI components/console, run_console
DEFAULT_CONSOLE_JOB_PUB_ENDPOINT = "tcp://127.0.0.1:6630"
DEFAULT_CONSOLE_RESULT_SUB_ENDPOINT = "tcp://127.0.0.1:6631"
DEFAULT_RUN_CONSOLE_JOB_PUB_ENDPOINT = "tcp://127.0.0.1:6660"
DEFAULT_RUN_CONSOLE_RESULT_SUB_ENDPOINT = "tcp://127.0.0.1:6670"
DEFAULT_CONSOLE_EXECUTION_TIMEOUT_S = 120.0
DEFAULT_CONSOLE_WORKFLOWS_CONCURRENT_CALLS = 2

# GUI rag_update_handler
RAG_UPDATE_DEFAULT_RESPONSE_TIMEOUT = 6000.0
