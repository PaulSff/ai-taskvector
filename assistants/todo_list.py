"""
Todo list attached to the graph (metadata). Used by assistants via graph edit actions.
Operates on dict representation: todo_list = { "id", "title?", "tasks": [ { "id", "text", "completed", "created_at" } ] }.
"""
