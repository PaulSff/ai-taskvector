"""
Shared types for assistant skills (Phase 2+).

Skills will consume normalized parser output and a narrow follow-up context protocol.
"""
...
class FollowUpContribution:
    """Result of running one skill in a follow-up round."""
