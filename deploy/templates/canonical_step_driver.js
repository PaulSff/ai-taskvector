// Canonical StepDriver: trigger (reset|step) -> output 0 = start (to Split), output 1 = response, output 2 = trigger (to StepRewards).
...
if (trigger === 'reset') {
  return [{ payload: { action: 'start' } }, { payload: { action: 'idle' } }, { payload: trigger }];
}
return [{ payload: { action: 'step' } }, {}, { payload: trigger }];
