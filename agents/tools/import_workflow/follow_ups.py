...
# Injected as ``follow_up_context`` / system-side copy for the first post-apply agent round when
# ``PostExecuteFlags.had_import_workflow`` is true (see ``gui.chat.parser_follow_up.chain``).
...
IMPORT_POST_APPLY_USER_MESSAGE = "Review the workflow just imported. Describe how it works and how to use it. Respond in {session_language}."
