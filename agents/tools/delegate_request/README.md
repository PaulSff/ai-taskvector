...
Hand the chat to another agent, or drive **auto-delegation** workflow using LLM-based analysis on the user_message to pick the best suitable role to handle.
