...
TOOL_ACTION_PROMPT_LINE = ("""- Calendar actions:
        ...
        - check_availability: "action": "calendar", "method": "check_availability", "cal_file_name": "calendar.ics", "period_d": 30, "include_scheduled_events": false/true, "availability": [ {"periodic": { "from_day_of_week": "mon", "to_day_of_week": "fri", "from_time": "09:00", "to_time": "17:00" } } ] } -  Set `include_scheduled_events: true` to include reserved events.
