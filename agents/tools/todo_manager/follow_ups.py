...
TODO_MANAGER_REVIEW_SYSTEM = "IMPORTANT: The TODO list has been updated. You must review the TODO list. Respond in {session_language}."
TODO_MANAGER_REVIEW_USER_MESSAGE = "Review the TODO list and continue. When the job is finished provide a brief summary. Respond in {session_language}."
