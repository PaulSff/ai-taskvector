"""read_code_block tool: follow-up prompt fragments."""

from agents.tools.follow_up_common import FOLLOW_UP_RESPONSE_SESSION_SUFFIX

READ_CODE_BLOCK_FOLLOW_UP_PREFIX = "IMPORTANT: You requested code block(s) from the graph. You must check the code.\n\n"
