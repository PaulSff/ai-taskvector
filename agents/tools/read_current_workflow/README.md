...
- `agents/tools/registry.py` → `TOOL_RUNNERS["read_current_workflow"]`
- `agents/tools/catalog.py` → `ORDERED_ANALYST_TOOLS` (not Workflow Designer; WD already gets a full graph summary in the default inject)
