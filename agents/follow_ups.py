...
DEFAULT_POST_APPLY_FOLLOW_UP_INJECT = (
    "IMPORTANT: Your edits were applied. You must review the the current search results, graph summary, recent changes, follow up context, fix the issues if there are any. "
...
DEFAULT_FOLLOW_UP_USER_MESSAGE = "Check out the result. Share a brief summary. Respond in {session_language}."
