"""Analyst agent prompt template (structured sections for ``config/prompts/analyst.json``).

Canonical location: ``agents/roles/analyst/prompts.py``. Re-exported from ``agents.prompts``.
