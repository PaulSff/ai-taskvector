"""
Framework-agnostic workflow helpers for role-based agent chat.

These are the same helpers as gui.chat.agent_workflow.helpers but live here so that
units/canonical/agent_orchestrator can import them without going through gui/chat/agent_workflow.

gui.chat.agent_workflow still re-exports everything from here for backward compatibility.
"""
