# AI TaskVector RAG Module (memory & knowledge base)

Semantic search over workflows, nodes, repo source and user documents. Uses **ChromaDB** and **sentence-transformers** (canonical **Embedder** / **ChromaIndexer** units). Runs on **CPU** (no GPU required).
