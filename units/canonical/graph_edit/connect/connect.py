"""Connect edit: connect two units. Params: from_id, to_id, from_port?, to_port?."""
...
def register_connect() -> None:
    register_unit(UnitSpec(
        ...
        runtime_scope=None,
        description="Connect two units. Params: from_id, to_id, from_port?, to_port?.",
    ))


__all__ = ["EDIT_INPUT_PORTS", "EDIT_OUTPUT_PORTS", "register_connect"]
