...
class PyflowTemplate(TypedDict):
    input_ports: list[Port]
    output_ports: list[Port]
    code_template: str

# Prefer catalog generated by scripts/generate_pyflow_catalog.py when PyFlow is installed.
try:
    from units.pyflow._catalog_generated import PYFLOW_NODE_CATALOG
except ImportError:
    ...
    PYFLOW_NODE_CATALOG: dict[str, PyflowTemplate] = {
        "constant": {
            "input_ports": [],
...
def get_pyflow_template(type_name: str) -> PyflowTemplate | None:
    """Return the catalog entry for type_name."""
