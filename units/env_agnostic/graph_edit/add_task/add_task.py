"""Add-task edit: add task to todo list. Params: text."""
...
def _step(
    ...
    edit = {"action": "add_task", "text": (params or {}).get("text")}
    return apply_edit(inputs, state, edit)


def register_add_task() -> None:
    register_unit(UnitSpec(
        ...
        runtime_scope=None,
        description="Add task to todo list. Params: text.",
    ))
